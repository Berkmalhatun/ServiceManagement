...
public enum ErrorType {
    ...
    USER_NOT_FOUND(4006,"User is not found please try again",HttpStatus.BAD_REQUEST),
    ACTIVATION_CODE_UNMATCH(4007,"Activation code are not matched",HttpStatus.BAD_REQUEST),
