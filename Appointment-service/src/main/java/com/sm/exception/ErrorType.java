...
public enum ErrorType {
    ...
    APPOINTMENT_NOT_FOUND(4010,"The appointment  is not found.",HttpStatus.BAD_REQUEST),
    APPOINTMENT_DELETED_NOT_FOUND(4011,"The appointment deleted is not found.",HttpStatus.BAD_REQUEST),
    APPOINTMENT_ACTIVE_NOT_FOUND(4012,"The appointment active is not found.",HttpStatus.BAD_REQUEST),
    APPOINTMENT_PASSIVE_NOT_FOUND(4013,"The appointment passive is not found.",HttpStatus.BAD_REQUEST),
